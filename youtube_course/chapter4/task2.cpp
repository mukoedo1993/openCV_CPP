...
int main()
{
    Mat img(512, 512, CV_8UC3,/*YOU Have a range of 0-255 or -122 to 121.*/Scalar(255,0,0));
     ...
     circle(img, Point(256, 256),155, Scalar(0, 69, 255),FILLED);//The circle is filled here.
      circle(img1, Point(256, 256),155, Scalar(0, 69, 255));
    

    imshow("Image",img);// pop up an image with filled rectangle

    imshow("Image1",img1);// pop up an image with unfilled rectangle
